...
>
  ...
  <div>
    <h1 class="p-2 font-bold tracking-tight text-6xl md:text-8xl text-white">
      Hey! I'm<br />
      Mihran<br />
      Mashhud
    </h1>
    <h2 class="p-2 font-bold tracking-tighter text-3xl text-white">Web Developer</h2>
  </div>
</div>
